...
public class Queues {
    ...
    public static final String PAMCARY_TRAVEL_DOCUMENTS = "pamcary.travel.documents";
    public static final String PAMCARY_AUTHORIZATION_SUPPLY = "pamcary.authorization.supply";
