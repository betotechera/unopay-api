...
public class RemittanceLayout {
    ...
    private static final Map<String, RecordColumnRule> batchHeader = new HashMap<String, RecordColumnRule>(){{
        ...
        put(AGENCIA, new RecordColumnRule(12,53,57,5, ColumnType.NUMBER));
        put(DIGITO_AGENCIA, new RecordColumnRule(13,58,58,1, ColumnType.ALPHA));
        put(NUMERO_CONTA, new RecordColumnRule(14,59,70,12, ColumnType.NUMBER));
        put(DIGITO_CONTA, new RecordColumnRule(15,71,71,1, ColumnType.ALPHA));
        put(DIGITO_AGENCIA_CONTA, new RecordColumnRule(16,72,72,1, ColumnType.ALPHA));
        put(NOME_EMPRESA, new RecordColumnRule(17,73,102,30, ColumnType.ALPHA));
        put(MENSAGEM, new RecordColumnRule(18,103,142,40, ColumnType.ALPHA));
        put(LOGRADOURO, new RecordColumnRule(19,143,172,30, ColumnType.ALPHA));
        put(NUMERO, new RecordColumnRule(20,173,177,5, ColumnType.NUMBER));
        put(COMPLEMENTO, new RecordColumnRule(21,178,192,15, ColumnType.ALPHA));
        put(CIDADE, new RecordColumnRule(22,193,212,20, ColumnType.ALPHA));
        put(CEP, new RecordColumnRule(23,213,217,5, ColumnType.NUMBER));
        put(COMPLEMENTO_CEP, new RecordColumnRule(24,218,220,3, ColumnType.ALPHA));
        put(ESTADO, new RecordColumnRule(25,221,222,2, ColumnType.ALPHA));
        put(FIM_FEBRABAN, new RecordColumnRule(26,223,230,8, ColumnType.ALPHA));
        put(OCORRENCIAS, new RecordColumnRule(27,231,240,10, ColumnType.ALPHA));
    }};
