...
public abstract class ItauRemittanceLayout {
    ...
    private static final Map<String, RecordColumnRule> remittanceHeader = new HashMap<String, RecordColumnRule>(){

     {
        ...
        put(BRANCOS_3, new RecordColumnRule(10, 58, 58, 1, ColumnType.ALPHA));
        put(NUMERO_CONTA, new RecordColumnRule(11, 59, 70, 12, ColumnType.NUMBER));
        put(BRANCO_4, new RecordColumnRule(12, 71, 71, 1, ColumnType.ALPHA));
        put(DIGITO_AGENCIA_CONTA, new RecordColumnRule(13, 72, 72, 1, ColumnType.ALPHA));
        put(NOME_EMPRESA, new RecordColumnRule(14, 73, 102, 30, ColumnType.ALPHA));
        put(NOME_BANCO, new RecordColumnRule(15, 103, 132, 30, ColumnType.ALPHA));
        put(BRANCOS_5, new RecordColumnRule(16, 133, 142, 10, ColumnType.ALPHA));
        put(CODIGO_REMESSA, new RecordColumnRule(17, 143, 143, 1, "1", ColumnType.NUMBER));
        put(DATA_GERACAO_ARQUIVO, new RecordColumnRule(18, 144, 151, 8, ColumnType.NUMBER));
        put(HORA_GERACAO_ARQUIVO, new RecordColumnRule(19, 152, 157, 6, ColumnType.NUMBER));
        put(BRANCOS_6, new RecordColumnRule(20, 158, 166, 9, ColumnType.NUMBER));
        put(DENSIDADE_GRAVACAO, new RecordColumnRule(21, 167, 171, 5, "1600", ColumnType.NUMBER));
        put(RESERVADO_BANCO, new RecordColumnRule(22, 172, 240, 69, ColumnType.ALPHA));
    }};
