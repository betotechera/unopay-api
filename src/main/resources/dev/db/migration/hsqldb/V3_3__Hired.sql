...
insert into oauth_group_authorities(authority, group_id) values('ROLE_LIST_HIRED', '1');
insert into oauth_group_authorities(authority, group_id) values('ROLE_MANAGE_HIRED', '1');
