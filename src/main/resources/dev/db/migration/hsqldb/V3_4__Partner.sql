...
insert into oauth_group_authorities(authority, group_id) values('ROLE_LIST_PARTNER', '1');
insert into oauth_group_authorities(authority, group_id) values('ROLE_MANAGE_PARTNER', '1');
