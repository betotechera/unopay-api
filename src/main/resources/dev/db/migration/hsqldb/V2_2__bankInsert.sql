...
insert into payment_bank_account(id, bank_account_id, authorize_transfer,deposit_period, pre_paid_payment_days, post_paid_payment_days, bank_agreement_number) values ('1', '1', '1', 'WEEKLY', 1, 1, '0000000')