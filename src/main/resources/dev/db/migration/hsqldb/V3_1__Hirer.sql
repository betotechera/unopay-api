...
insert into oauth_group_authorities(authority, group_id) values('ROLE_LIST_HIRER', '1');
insert into oauth_group_authorities(authority, group_id) values('ROLE_MANAGE_HIRER', '1');
