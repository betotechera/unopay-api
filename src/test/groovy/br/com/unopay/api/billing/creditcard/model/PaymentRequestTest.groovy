...
class PaymentRequestTest extends FixtureApplicationTest {
    ...
    def 'given a payment request with method equals card and store card equals true shouldStoreCard should return true'(){
    ...
    def 'given a payment request with method not equals card shouldStoreCard should return false'(){
    ...
    def 'given a payment request with store card equals false shouldStoreCard should return false'(){
